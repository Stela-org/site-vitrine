...
export const CITIES: City[] = [
  ...
  },
  {
    ...
    metaDesc: "Du Vieux-Port au Panier, ne dépendez plus de la seule saison estivale : collectez des avis Google toute l'année pour votre restaurant marseillais. Essai gratuit.",
  ...
  },
  {
    ...
    metaDesc: "Dans une ville où l'art de vivre est un argument, soignez la réputation Google de votre restaurant bordelais, des Chartrons aux quais. Réponses IA, essai gratuit.",
