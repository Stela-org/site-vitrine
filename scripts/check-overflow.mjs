...
const PAGES = ["/", "/roadmap", "/diagnostic", "/tarifs", "/fonctionnalites", "/collecte-avis-google", "/pour/coiffeur", "/restaurants-lyon", "/comparatif", "/blog/repondre-avis-negatif-google-restaurant", "/blog/geo-ou-seo-commerce-local", "/blog/mesurer-visibilite-ia-commerce-local", "/blog/etre-recommande-par-chatgpt-commerce-local", "/notre-histoire", "/statistiques-avis-google-france", "/guide-google-commercant-local", "/nuage-burger-gennevilliers"];
